...
% top_n_map = 10;
% top_n_ndcg = 500;
% [Mean_MAP_Hierarchy, MAP_Hierarchy] = MAP(Result_Hierarchy, mmu_mgi_mp_aligned,top_n_map);
% [Mean_MAP_NoHierarchy, MAP_NoHierarchy] = MAP(Result_NoHierarchy, mmu_mgi_mp_aligned,top_n_map);
%[Mean_NDCG_Hierarchy, NDCG_Hierarchy] = NDCG(Result_Hierarchy, mmu_mgi_mp_aligned,top_n_ndcg);
%[Mean_NDCG_NoHierarchy, NDCG_NoHierarchy] = NDCG(Result_NoHierarchy, mmu_mgi_mp_aligned,top_n_ndcg);
